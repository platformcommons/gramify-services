...
public interface DbUtilService {
    ...
    Map<String,Long> getCountsAffected(Long tenantId,String dbName,String tenantIdentifierColumn,Set<String> tableNames) throws Exception;

    byte[] getDumpScripts(String dbName, Long tenantId, String tenantIdentifierColumn) throws Exception;

    byte[] generateDeleteScripts(String dbName, Long tenantId, String tenantIdentifierColumn) throws Exception;
    ...
    byte[] getSqlFromChangeLog(MultipartFile file, Boolean generateRollback);
}
