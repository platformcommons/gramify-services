...
public class SurplusMovedThroughFacadeExtImpl extends SurplusMovedThroughFacadeImpl implements SurplusMovedThroughFacadeExt {


    /**
     * Constructs a new SurplusMovedThroughFacadeExtImpl.
     *
     * @param serviceExt   the SurplusMovedThrough service extension
     * @param producer  the SurplusMovedThrough producer
     * @param evaluator the policy evaluator
     */
    public SurplusMovedThroughFacadeExtImpl(SurplusMovedThroughServiceExt serviceExt, SurplusMovedThroughProducer producer, PolicyEvaluator evaluator) {
