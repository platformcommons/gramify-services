...
public class HHGovernanceAspirationFacadeExtImpl extends HHGovernanceAspirationFacadeImpl implements HHGovernanceAspirationFacadeExt {


    /**
     * Constructs a new HHGovernanceAspirationFacadeExtImpl.
     *
     * @param serviceExt   the HHGovernanceAspiration service extension
     * @param producer  the HHGovernanceAspiration producer
     * @param evaluator the policy evaluator
     */
    public HHGovernanceAspirationFacadeExtImpl(HHGovernanceAspirationServiceExt serviceExt, HHGovernanceAspirationProducer producer, PolicyEvaluator evaluator) {
