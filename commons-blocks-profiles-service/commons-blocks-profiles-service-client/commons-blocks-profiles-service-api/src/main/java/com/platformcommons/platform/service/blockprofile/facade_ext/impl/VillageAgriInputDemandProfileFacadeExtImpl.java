...
public class VillageAgriInputDemandProfileFacadeExtImpl extends VillageAgriInputDemandProfileFacadeImpl implements VillageAgriInputDemandProfileFacadeExt {


    /**
     * Constructs a new VillageAgriInputDemandProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageAgriInputDemandProfile service extension
     * @param producer  the VillageAgriInputDemandProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageAgriInputDemandProfileFacadeExtImpl(VillageAgriInputDemandProfileServiceExt serviceExt, VillageAgriInputDemandProfileProducer producer, PolicyEvaluator evaluator) {
