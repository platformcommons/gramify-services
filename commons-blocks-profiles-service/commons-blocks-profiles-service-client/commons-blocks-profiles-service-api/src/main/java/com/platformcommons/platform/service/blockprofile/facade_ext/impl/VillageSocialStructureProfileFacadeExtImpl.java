...
public class VillageSocialStructureProfileFacadeExtImpl extends VillageSocialStructureProfileFacadeImpl implements VillageSocialStructureProfileFacadeExt {


    /**
     * Constructs a new VillageSocialStructureProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageSocialStructureProfile service extension
     * @param producer  the VillageSocialStructureProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageSocialStructureProfileFacadeExtImpl(VillageSocialStructureProfileServiceExt serviceExt, VillageSocialStructureProfileProducer producer, PolicyEvaluator evaluator) {
