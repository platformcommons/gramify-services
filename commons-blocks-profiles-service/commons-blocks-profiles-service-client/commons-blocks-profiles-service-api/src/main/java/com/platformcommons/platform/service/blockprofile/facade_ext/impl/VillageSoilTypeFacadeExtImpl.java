...
public class VillageSoilTypeFacadeExtImpl extends VillageSoilTypeFacadeImpl implements VillageSoilTypeFacadeExt {


    /**
     * Constructs a new VillageSoilTypeFacadeExtImpl.
     *
     * @param serviceExt   the VillageSoilType service extension
     * @param producer  the VillageSoilType producer
     * @param evaluator the policy evaluator
     */
    public VillageSoilTypeFacadeExtImpl(VillageSoilTypeServiceExt serviceExt, VillageSoilTypeProducer producer, PolicyEvaluator evaluator) {
