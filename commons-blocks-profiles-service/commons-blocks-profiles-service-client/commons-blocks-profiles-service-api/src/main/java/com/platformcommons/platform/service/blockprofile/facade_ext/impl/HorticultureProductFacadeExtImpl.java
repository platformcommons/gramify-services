...
public class HorticultureProductFacadeExtImpl extends HorticultureProductFacadeImpl implements HorticultureProductFacadeExt {


    /**
     * Constructs a new HorticultureProductFacadeExtImpl.
     *
     * @param serviceExt   the HorticultureProduct service extension
     * @param producer  the HorticultureProduct producer
     * @param evaluator the policy evaluator
     */
    public HorticultureProductFacadeExtImpl(HorticultureProductServiceExt serviceExt, HorticultureProductProducer producer, PolicyEvaluator evaluator) {
