...
public class VillageFisheriesProfileFacadeExtImpl extends VillageFisheriesProfileFacadeImpl implements VillageFisheriesProfileFacadeExt {


    /**
     * Constructs a new VillageFisheriesProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageFisheriesProfile service extension
     * @param producer  the VillageFisheriesProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageFisheriesProfileFacadeExtImpl(VillageFisheriesProfileServiceExt serviceExt, VillageFisheriesProfileProducer producer, PolicyEvaluator evaluator) {
