...
public class VillageHorticultureProfileFacadeExtImpl extends VillageHorticultureProfileFacadeImpl implements VillageHorticultureProfileFacadeExt {


    /**
     * Constructs a new VillageHorticultureProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageHorticultureProfile service extension
     * @param producer  the VillageHorticultureProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageHorticultureProfileFacadeExtImpl(VillageHorticultureProfileServiceExt serviceExt, VillageHorticultureProfileProducer producer, PolicyEvaluator evaluator) {
