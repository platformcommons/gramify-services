...
public class VillageSkillShortageTypeFacadeExtImpl extends VillageSkillShortageTypeFacadeImpl implements VillageSkillShortageTypeFacadeExt {


    /**
     * Constructs a new VillageSkillShortageTypeFacadeExtImpl.
     *
     * @param serviceExt   the VillageSkillShortageType service extension
     * @param producer  the VillageSkillShortageType producer
     * @param evaluator the policy evaluator
     */
    public VillageSkillShortageTypeFacadeExtImpl(VillageSkillShortageTypeServiceExt serviceExt, VillageSkillShortageTypeProducer producer, PolicyEvaluator evaluator) {
