...
public class ArtisanTypeFacadeExtImpl extends ArtisanTypeFacadeImpl implements ArtisanTypeFacadeExt {


    /**
     * Constructs a new ArtisanTypeFacadeExtImpl.
     *
     * @param serviceExt   the ArtisanType service extension
     * @param producer  the ArtisanType producer
     * @param evaluator the policy evaluator
     */
    public ArtisanTypeFacadeExtImpl(ArtisanTypeServiceExt serviceExt, ArtisanTypeProducer producer, PolicyEvaluator evaluator) {
