...
public class VillageCropProfileFacadeExtImpl extends VillageCropProfileFacadeImpl implements VillageCropProfileFacadeExt {


    /**
     * Constructs a new VillageCropProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageCropProfile service extension
     * @param producer  the VillageCropProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageCropProfileFacadeExtImpl(VillageCropProfileServiceExt serviceExt, VillageCropProfileProducer producer, PolicyEvaluator evaluator) {
