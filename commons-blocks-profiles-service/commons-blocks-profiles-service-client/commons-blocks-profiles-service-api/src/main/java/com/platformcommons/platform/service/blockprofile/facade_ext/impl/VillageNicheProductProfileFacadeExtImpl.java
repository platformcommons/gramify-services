...
public class VillageNicheProductProfileFacadeExtImpl extends VillageNicheProductProfileFacadeImpl implements VillageNicheProductProfileFacadeExt {


    /**
     * Constructs a new VillageNicheProductProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageNicheProductProfile service extension
     * @param producer  the VillageNicheProductProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageNicheProductProfileFacadeExtImpl(VillageNicheProductProfileServiceExt serviceExt, VillageNicheProductProfileProducer producer, PolicyEvaluator evaluator) {
