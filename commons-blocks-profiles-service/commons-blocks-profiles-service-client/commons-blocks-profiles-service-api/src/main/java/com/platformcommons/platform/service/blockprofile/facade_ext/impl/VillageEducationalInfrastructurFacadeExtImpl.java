...
public class VillageEducationalInfrastructurFacadeExtImpl extends VillageEducationalInfrastructurFacadeImpl implements VillageEducationalInfrastructurFacadeExt {


    /**
     * Constructs a new VillageEducationalInfrastructurFacadeExtImpl.
     *
     * @param serviceExt   the VillageEducationalInfrastructur service extension
     * @param producer  the VillageEducationalInfrastructur producer
     * @param evaluator the policy evaluator
     */
    public VillageEducationalInfrastructurFacadeExtImpl(VillageEducationalInfrastructurServiceExt serviceExt, VillageEducationalInfrastructurProducer producer, PolicyEvaluator evaluator) {
