...
public class VillageCulturalResourceProfileFacadeExtImpl extends VillageCulturalResourceProfileFacadeImpl implements VillageCulturalResourceProfileFacadeExt {


    /**
     * Constructs a new VillageCulturalResourceProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageCulturalResourceProfile service extension
     * @param producer  the VillageCulturalResourceProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageCulturalResourceProfileFacadeExtImpl(VillageCulturalResourceProfileServiceExt serviceExt, VillageCulturalResourceProfileProducer producer, PolicyEvaluator evaluator) {
