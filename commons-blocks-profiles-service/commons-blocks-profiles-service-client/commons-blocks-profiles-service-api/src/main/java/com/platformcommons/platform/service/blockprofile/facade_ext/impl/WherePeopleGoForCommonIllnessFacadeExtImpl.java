...
public class WherePeopleGoForCommonIllnessFacadeExtImpl extends WherePeopleGoForCommonIllnessFacadeImpl implements WherePeopleGoForCommonIllnessFacadeExt {


    /**
     * Constructs a new WherePeopleGoForCommonIllnessFacadeExtImpl.
     *
     * @param serviceExt   the WherePeopleGoForCommonIllness service extension
     * @param producer  the WherePeopleGoForCommonIllness producer
     * @param evaluator the policy evaluator
     */
    public WherePeopleGoForCommonIllnessFacadeExtImpl(WherePeopleGoForCommonIllnessServiceExt serviceExt, WherePeopleGoForCommonIllnessProducer producer, PolicyEvaluator evaluator) {
