...
public class VillageServiceDemandProfileFacadeExtImpl extends VillageServiceDemandProfileFacadeImpl implements VillageServiceDemandProfileFacadeExt {


    /**
     * Constructs a new VillageServiceDemandProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageServiceDemandProfile service extension
     * @param producer  the VillageServiceDemandProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageServiceDemandProfileFacadeExtImpl(VillageServiceDemandProfileServiceExt serviceExt, VillageServiceDemandProfileProducer producer, PolicyEvaluator evaluator) {
