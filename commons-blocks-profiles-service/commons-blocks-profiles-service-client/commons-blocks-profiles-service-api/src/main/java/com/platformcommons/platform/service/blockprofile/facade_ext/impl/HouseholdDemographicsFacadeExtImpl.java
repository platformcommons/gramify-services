...
public class HouseholdDemographicsFacadeExtImpl extends HouseholdDemographicsFacadeImpl implements HouseholdDemographicsFacadeExt {


    /**
     * Constructs a new HouseholdDemographicsFacadeExtImpl.
     *
     * @param serviceExt   the HouseholdDemographics service extension
     * @param producer  the HouseholdDemographics producer
     * @param evaluator the policy evaluator
     */
    public HouseholdDemographicsFacadeExtImpl(HouseholdDemographicsServiceExt serviceExt, HouseholdDemographicsProducer producer, PolicyEvaluator evaluator) {
