...
public class HHSocialConstraintsFacadeExtImpl extends HHSocialConstraintsFacadeImpl implements HHSocialConstraintsFacadeExt {


    /**
     * Constructs a new HHSocialConstraintsFacadeExtImpl.
     *
     * @param serviceExt   the HHSocialConstraints service extension
     * @param producer  the HHSocialConstraints producer
     * @param evaluator the policy evaluator
     */
    public HHSocialConstraintsFacadeExtImpl(HHSocialConstraintsServiceExt serviceExt, HHSocialConstraintsProducer producer, PolicyEvaluator evaluator) {
