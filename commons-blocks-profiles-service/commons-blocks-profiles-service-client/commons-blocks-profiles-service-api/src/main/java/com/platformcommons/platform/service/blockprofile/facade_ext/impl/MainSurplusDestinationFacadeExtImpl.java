...
public class MainSurplusDestinationFacadeExtImpl extends MainSurplusDestinationFacadeImpl implements MainSurplusDestinationFacadeExt {


    /**
     * Constructs a new MainSurplusDestinationFacadeExtImpl.
     *
     * @param serviceExt   the MainSurplusDestination service extension
     * @param producer  the MainSurplusDestination producer
     * @param evaluator the policy evaluator
     */
    public MainSurplusDestinationFacadeExtImpl(MainSurplusDestinationServiceExt serviceExt, MainSurplusDestinationProducer producer, PolicyEvaluator evaluator) {
