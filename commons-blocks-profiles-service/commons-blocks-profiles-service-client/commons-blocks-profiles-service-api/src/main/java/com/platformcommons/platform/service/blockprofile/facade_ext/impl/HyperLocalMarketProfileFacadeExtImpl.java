...
public class HyperLocalMarketProfileFacadeExtImpl extends HyperLocalMarketProfileFacadeImpl implements HyperLocalMarketProfileFacadeExt {


    /**
     * Constructs a new HyperLocalMarketProfileFacadeExtImpl.
     *
     * @param serviceExt   the HyperLocalMarketProfile service extension
     * @param producer  the HyperLocalMarketProfile producer
     * @param evaluator the policy evaluator
     */
    public HyperLocalMarketProfileFacadeExtImpl(HyperLocalMarketProfileServiceExt serviceExt, HyperLocalMarketProfileProducer producer, PolicyEvaluator evaluator) {
