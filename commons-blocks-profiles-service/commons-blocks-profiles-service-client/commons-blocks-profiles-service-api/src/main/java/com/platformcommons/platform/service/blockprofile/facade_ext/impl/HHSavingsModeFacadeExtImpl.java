...
public class HHSavingsModeFacadeExtImpl extends HHSavingsModeFacadeImpl implements HHSavingsModeFacadeExt {


    /**
     * Constructs a new HHSavingsModeFacadeExtImpl.
     *
     * @param serviceExt   the HHSavingsMode service extension
     * @param producer  the HHSavingsMode producer
     * @param evaluator the policy evaluator
     */
    public HHSavingsModeFacadeExtImpl(HHSavingsModeServiceExt serviceExt, HHSavingsModeProducer producer, PolicyEvaluator evaluator) {
