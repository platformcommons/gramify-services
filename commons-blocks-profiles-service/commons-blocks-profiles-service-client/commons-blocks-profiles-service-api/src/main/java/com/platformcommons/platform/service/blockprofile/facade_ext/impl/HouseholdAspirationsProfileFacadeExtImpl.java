...
public class HouseholdAspirationsProfileFacadeExtImpl extends HouseholdAspirationsProfileFacadeImpl implements HouseholdAspirationsProfileFacadeExt {


    /**
     * Constructs a new HouseholdAspirationsProfileFacadeExtImpl.
     *
     * @param serviceExt   the HouseholdAspirationsProfile service extension
     * @param producer  the HouseholdAspirationsProfile producer
     * @param evaluator the policy evaluator
     */
    public HouseholdAspirationsProfileFacadeExtImpl(HouseholdAspirationsProfileServiceExt serviceExt, HouseholdAspirationsProfileProducer producer, PolicyEvaluator evaluator) {
