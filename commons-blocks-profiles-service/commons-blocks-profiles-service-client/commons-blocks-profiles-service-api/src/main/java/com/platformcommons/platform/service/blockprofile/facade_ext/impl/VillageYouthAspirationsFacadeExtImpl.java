...
public class VillageYouthAspirationsFacadeExtImpl extends VillageYouthAspirationsFacadeImpl implements VillageYouthAspirationsFacadeExt {


    /**
     * Constructs a new VillageYouthAspirationsFacadeExtImpl.
     *
     * @param serviceExt   the VillageYouthAspirations service extension
     * @param producer  the VillageYouthAspirations producer
     * @param evaluator the policy evaluator
     */
    public VillageYouthAspirationsFacadeExtImpl(VillageYouthAspirationsServiceExt serviceExt, VillageYouthAspirationsProducer producer, PolicyEvaluator evaluator) {
