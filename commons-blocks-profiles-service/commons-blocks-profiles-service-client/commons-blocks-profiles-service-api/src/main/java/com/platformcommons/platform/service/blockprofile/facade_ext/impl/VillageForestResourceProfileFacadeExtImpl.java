...
public class VillageForestResourceProfileFacadeExtImpl extends VillageForestResourceProfileFacadeImpl implements VillageForestResourceProfileFacadeExt {


    /**
     * Constructs a new VillageForestResourceProfileFacadeExtImpl.
     *
     * @param serviceExt   the VillageForestResourceProfile service extension
     * @param producer  the VillageForestResourceProfile producer
     * @param evaluator the policy evaluator
     */
    public VillageForestResourceProfileFacadeExtImpl(VillageForestResourceProfileServiceExt serviceExt, VillageForestResourceProfileProducer producer, PolicyEvaluator evaluator) {
