...
public class HouseholdConstraintsProfileFacadeExtImpl extends HouseholdConstraintsProfileFacadeImpl implements HouseholdConstraintsProfileFacadeExt {


    /**
     * Constructs a new HouseholdConstraintsProfileFacadeExtImpl.
     *
     * @param serviceExt   the HouseholdConstraintsProfile service extension
     * @param producer  the HouseholdConstraintsProfile producer
     * @param evaluator the policy evaluator
     */
    public HouseholdConstraintsProfileFacadeExtImpl(HouseholdConstraintsProfileServiceExt serviceExt, HouseholdConstraintsProfileProducer producer, PolicyEvaluator evaluator) {
