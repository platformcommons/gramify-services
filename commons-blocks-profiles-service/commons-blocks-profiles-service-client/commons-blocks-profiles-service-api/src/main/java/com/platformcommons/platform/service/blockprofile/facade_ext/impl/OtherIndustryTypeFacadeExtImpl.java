...
public class OtherIndustryTypeFacadeExtImpl extends OtherIndustryTypeFacadeImpl implements OtherIndustryTypeFacadeExt {


    /**
     * Constructs a new OtherIndustryTypeFacadeExtImpl.
     *
     * @param serviceExt   the OtherIndustryType service extension
     * @param producer  the OtherIndustryType producer
     * @param evaluator the policy evaluator
     */
    public OtherIndustryTypeFacadeExtImpl(OtherIndustryTypeServiceExt serviceExt, OtherIndustryTypeProducer producer, PolicyEvaluator evaluator) {
