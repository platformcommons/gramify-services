...
public class CommonRepairNeedFacadeExtImpl extends CommonRepairNeedFacadeImpl implements CommonRepairNeedFacadeExt {


    /**
     * Constructs a new CommonRepairNeedFacadeExtImpl.
     *
     * @param serviceExt   the CommonRepairNeed service extension
     * @param producer  the CommonRepairNeed producer
     * @param evaluator the policy evaluator
     */
    public CommonRepairNeedFacadeExtImpl(CommonRepairNeedServiceExt serviceExt, CommonRepairNeedProducer producer, PolicyEvaluator evaluator) {
