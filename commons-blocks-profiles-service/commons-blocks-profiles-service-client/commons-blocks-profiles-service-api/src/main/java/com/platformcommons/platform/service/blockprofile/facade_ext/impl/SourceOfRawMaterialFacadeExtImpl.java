...
public class SourceOfRawMaterialFacadeExtImpl extends SourceOfRawMaterialFacadeImpl implements SourceOfRawMaterialFacadeExt {


    /**
     * Constructs a new SourceOfRawMaterialFacadeExtImpl.
     *
     * @param serviceExt   the SourceOfRawMaterial service extension
     * @param producer  the SourceOfRawMaterial producer
     * @param evaluator the policy evaluator
     */
    public SourceOfRawMaterialFacadeExtImpl(SourceOfRawMaterialServiceExt serviceExt, SourceOfRawMaterialProducer producer, PolicyEvaluator evaluator) {
