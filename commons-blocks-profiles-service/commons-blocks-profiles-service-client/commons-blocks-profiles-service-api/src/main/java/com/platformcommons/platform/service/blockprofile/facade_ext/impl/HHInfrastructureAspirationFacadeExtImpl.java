...
public class HHInfrastructureAspirationFacadeExtImpl extends HHInfrastructureAspirationFacadeImpl implements HHInfrastructureAspirationFacadeExt {


    /**
     * Constructs a new HHInfrastructureAspirationFacadeExtImpl.
     *
     * @param serviceExt   the HHInfrastructureAspiration service extension
     * @param producer  the HHInfrastructureAspiration producer
     * @param evaluator the policy evaluator
     */
    public HHInfrastructureAspirationFacadeExtImpl(HHInfrastructureAspirationServiceExt serviceExt, HHInfrastructureAspirationProducer producer, PolicyEvaluator evaluator) {
